...
CREATE TABLE prod_products(product_id INT(5), product_name INT(5), market_value INT(3), quantity INT(3), 
                           daily_production INT(1), biweekly_production INT(1), production_cost INT(3));
